/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 2af3ce66e85da1de7605ddaa294d365d)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_BUILD_SHA: "${GIT_COMMIT_SHA}";
